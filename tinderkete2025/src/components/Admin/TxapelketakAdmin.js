    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-blue-600">Txapelketak kudeatu</h1>
                    <p className="text-xl mt-2 text-gray-600">Gune honetan txapelketak editatu, ezabatu edo sortu ditzakezu.</p>
                </div>
                <div>
                    <button
                        onClick={() => handleSortu()}
